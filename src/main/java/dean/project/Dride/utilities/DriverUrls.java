...
public class DriverUrls {
    public static final String DRIVER_BASE_URL = "/api/v1/driver";
    ...
    public static final String UPLOAD_LICENSE = "Please upload license image";
    public static final String COMPLETED= "Driver information updated successfully";
